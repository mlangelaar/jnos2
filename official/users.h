#ifndef _CONFIG_H
#define _CONFIG_H
/* This is one possible configuration for an end user */
...
#define SESSIONS	1
#define CALLCLI		1 /* Include only callbook client code (to query remote server) */
...
#undef REGISTER		1 /* Include User Registration option */
