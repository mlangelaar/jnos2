...
/* In tcphdr.c: */
struct mbuf *htontcp __ARGS((struct tcp *tcph,struct mbuf *data, struct pseudo_header *ph));
#ifdef	IPV6
/* 17Feb2023, Maiko, Oops forgot this, Ubuntu is not forgiving */
struct mbuf *htontcpv6 (struct tcp*, struct mbuf*, struct ipv6*);
#endif
...
#ifdef	IPV6
/* 23Feb2023, Maiko (VE4KLM), new function for IPV6 version */
void resetv6 (struct ipv6 *ipv6, struct tcp *seg);
#endif
