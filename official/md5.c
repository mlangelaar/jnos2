...
#if defined(CPU386) || defined(CPU486) || defined(CPU586)
/* Fast assembler version exists for 386/486 */
#define REGS32BIT 1
#pragma inline
#endif
...
#ifndef	REGS32BIT	/* Alternate defs exist for 386 assembler version */
...
MD5_CTX *mdContext;
{
   ...
   */
  mdContext->buf[0] = (UINT4)0x67452301U;
  mdContext->buf[1] = (UINT4)0xefcdab89U;
  mdContext->buf[2] = (UINT4)0x98badcfeU;
  mdContext->buf[3] = (UINT4)0x10325476U;
}
...
#ifndef	REGS32BIT	/* Fast assembler version exists for 386/486 */
