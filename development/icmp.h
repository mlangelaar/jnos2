...
#ifdef	IPV6
	/* 05Apr2023, Maiko, Time to support outgoing IPV6 address */
...
#ifdef IPV6
/* 16Apr2023, Maiko, Should prototype this */
int pingem6 (int s,unsigned char *target,int16 seq,int16 id,int16 len);
#endif
