...
/* 03Feb2023,Maiko, Might need to bump this up for IPV6 :]
   getting unexplainable crashes with ipv6_recv() call
   17Feb2023, Maiko, crashes had nothing to do with this, so leave this
   for now, it was '#if defined(INP2011) || defined(IPV6)' for a bit
 */
