...
/*
 * 20Feb2016, Maiko, No need to declare these, they're only
 * used within the lzhuf.c module, might as well stay static.
 * 14Apr2016, Maiko (VE4KLM), nope, need Encode in forward.c
 */
