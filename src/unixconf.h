#ifndef	_CONFIG_H
#define	_CONFIG_H
/* This is a configuration for a full Linux version of Jnos */
/* #define WHOFOR "n5knx" */
...
#define NNTPS		1 /* Netnews client and server */
...
#define MONITOR		1 /* Include monitor-style trace mode */
#define MONSTAMP	1 /* add time stamp to monitor-style trace headers */
#define DIALER		1 /* SLIP/PPP redial code */
...
#define RDATECLI	1 /* Time Protocol client */
...
#define MD5AUTHENTICATE	1 /* Accept MD5-Authenticated logins */
...
#undef TRANSLATEFROM	1 /* smtp server rewrites from addrs too */
...
#define UNIX_DIR_LIST	1 /* Unix-style output from DIR and ftp DIR cmds. */
...
#define DOSCMD		1 /* Include cd,copy,del,mkdir,pwd,ren,rmdir commands */
#define MAILMSG		1 /* Include mailmsg command */

#define SPLITSCREEN	1 /* Needed for split, netrom split, and ttylink cmds */
#define STATUSWIN	1 /* Up to 3 line status window */
#define STATUSWINCMD	1 /* status off|on command to modify status window */
...
#undef SHOWIDLE 1
#define RXECHO		1 /* Echo rx packet to another iface - WG7J */
#define REDIRECT	1 /* Allow cmd [options] > outfile. Use >> to append */
#define EDITOR		1 /* include internal ascii editor */
...
/* Some Linux options: */
#define SM_CURSES	1 /* curses session manager */
#define SM_DUMB		1 /* dumb session manager */
#define SM_RAW		1 /* raw terminfo session manager */
#define DOS_NAME_COMPAT	1 /* help cmd assumes max 8 char helpfile names */
...
#define RIP98		1 /* Include RIP98 routing */
...
#define RARP		1 /* Include Reverse Address Resolution Protocol */
#define BOOTPCLIENT	1 /* Include BootP protocol client */
...
#define RSYSOPSERVER	1 /* Tcp telnet-to-mbox-as-sysop server */
...
#define FTPSERV_XPERM	1 /* ftp server enhanced to work better with Web browsers */
...
#define RDATESERVER	1 /* Time Protocol server */
#define ECHOSERVER	1 /* Tcp echo server */
#define DISCARDSERVER	1 /* Tcp discard server */
#define TIPSERVER	1 /* Serial port tip server */
#define DOMAINSERVER	1 /* Udp Domain Name Server */
#define TERMSERVER	1 /* Async serial interface server */
#define IDENTSERVER	1 /* RFC 1413 identification server (113/tcp) */
#define BOOTPSERVER	1 /* Include BootP protocol server */
#define TCPGATE		1 /* TCPGATE redirector server */
...
#define QRZCALLB	1 /* QRZ callbook server. Note that you can NOT have */
			  /* BOTH Buckmaster and QRZ defined.If so, QRZ is used */

#define HTTP		1 /* Selcuk Ozturk's HTTP server on port 80 */
#undef HTTP_EXTLOG	1 /* HTTP: Add detailed access logging in "/wwwlogs" dir */
#define CGI_XBM_COUNTER	1 /* HTTP: Add an X-bitmap counter via CGI */
...
#define AXUISESSION	1 /* Ax.25 unproto (axui) command */
...
#define RLOGINSESSION	1 /* Rlogin client code */
#define TIPSESSION	1 /* tip - async dumb terminal emulator */
#define DIRSESSION	1 /* dir cmd */
#define MORESESSION	1 /* more - view ASCII file page by page */
#define REPEATSESSION	1 /* repeat cmd */
#define LOOKSESSION	1 /* follow user activity on the bbs */
#define DQUERYSESSION	1 /* Include "domain query" cmd */
...
#define GATECMDS	1 /* Include gateway related commands C,E,N,NR,P,PI,T */
#define GWTRACE		1 /* Log all gateway connects to the logfile */
...
#define FBBFWD		1 /* add FBB batched forwarding code (no compression) */
...
#define FWDFILE		1 /* Include forwarding-to-file (export) feature */
...
#define POLLEDKISS	1 /* G8BPQ Polled Multidrop KISS TNC code */
